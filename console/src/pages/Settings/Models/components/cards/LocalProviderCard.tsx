    ...
    >
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 10 }}>
          <Tag color="green">风险：{provider.risk_level || "low"}</Tag>
          <Tag color={healthColorMap[String(provider.health || "ready")] || "default"}>
            健康：{provider.health || "ready"}
          </Tag>
          <Tag color="geekblue">来源：{provider.model_source || "embedded"}</Tag>
