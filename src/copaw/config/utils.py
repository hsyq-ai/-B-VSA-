...
from ..constant import (
    ...
    DASHBOARD_SKILL_RULES_FILE,
    EXPERT_CENTER_SKILL_RULES_FILE,
...
def get_prompt_templates_path() -> Path:
    """Return prompt templates json path."""
    return (WORKING_DIR / PROMPT_TEMPLATES_FILE).expanduser()


def get_dashboard_skill_rules_path() -> Path:
    """Return dashboard skill rules json path."""
    return (WORKING_DIR / DASHBOARD_SKILL_RULES_FILE).expanduser()


def get_expert_center_skill_rules_path() -> Path:
    """Return expert center skill rules json path."""
    return (WORKING_DIR / EXPERT_CENTER_SKILL_RULES_FILE).expanduser()
