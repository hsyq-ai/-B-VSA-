...
# Prompt template storage file
PROMPT_TEMPLATES_FILE = EnvVarLoader.get_str(
    "COPAW_PROMPT_TEMPLATES_FILE",
    "prompt_templates.json",
)

# Dashboard skill rule storage file
DASHBOARD_SKILL_RULES_FILE = EnvVarLoader.get_str(
    "COPAW_DASHBOARD_SKILL_RULES_FILE",
    "dashboard_skill_rules.json",
)

# Expert center skill rule storage file
EXPERT_CENTER_SKILL_RULES_FILE = EnvVarLoader.get_str(
    "COPAW_EXPERT_CENTER_SKILL_RULES_FILE",
    "expert_center_skill_rules.json",
)
