...
def _sanitize_prompt_content(filename: str, content: str) -> str:
    """Strip legacy identity blocks that conflict with runtime identity injection."""
    cleaned = content
...
class PromptBuilder:
    ...
    def _load_file(self, filename: str) -> None:
        ...
        try:
            ...
            content = _sanitize_prompt_content(filename, content)
