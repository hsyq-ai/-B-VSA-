...
- If the final deliverable includes a PDF, this skill should be the primary creation path:
  1. create the `.docx`
  2. verify the `.docx`
  3. export `.pdf` using `soffice --headless --convert-to pdf`
- Do not generate a Chinese PDF directly with ReportLab when a DOCX export path is available.
